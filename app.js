...
var nah = nav.style.height 

var che = window.mobileCheck = function() {
    let check = false;
...
var ti = document.getElementById("tii")
...
function fall(){
    ti.style.transition= "top 0.85s"
    ti.style.top = "2px"

    
    
    full.style.transition= "top 0.85s"
    full.style.top = "0px"
    
    gr.style.transition= "top 0.85s"
    gr.style.top = "5px"
    con.style.top = "2vh"
}
...
function cl(){
    ...
    document.getElementById("conn").style.color = "#3ddc84"
}
